...
class PublicPopupControllerTest {
    ...
    @BeforeEach
    void setup() { mvc = MockMvcBuilders.webAppContextSetup(context).apply(springSecurity()).addFilters(new com.bjworld21.conference.publicsite.PublicSiteTestContext()).build(); }
