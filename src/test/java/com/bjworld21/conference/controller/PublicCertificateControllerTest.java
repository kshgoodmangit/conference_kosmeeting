...
class PublicCertificateControllerTest {
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(new PublicCertificateController(conferences)).addFilters(new com.bjworld21.conference.publicsite.PublicSiteTestContext()).build();
    }
