...
import com.bjworld21.conference.service.PublicPreRegistrationService;
...
class PublicPreRegistrationControllerTest {
    ...
    void setUp() {
        ...
        ).addFilters(new com.bjworld21.conference.publicsite.PublicSiteTestContext())
                .setControllerAdvice(new com.bjworld21.conference.publicsite.PublicApiAdvice(
    ...
    void rendersThePublishedOnlineRegistrationForm() {
        ...
        var site = new com.bjworld21.conference.publicsite.PublicSiteContext(1L, "apdrc8", "en", java.util.List.of("en", "ko"), "/apdrc8/en", "/api/public/1");
