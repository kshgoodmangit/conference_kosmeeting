...
class PublicMemberEmailVerificationControllerTest {
    ...
    void setup() {
        ...
        mvc = MockMvcBuilders.standaloneSetup(controller).apply(springSecurity(filters)).addFilters(new com.bjworld21.conference.publicsite.PublicSiteTestContext()).build();
    }
