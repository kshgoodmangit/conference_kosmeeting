...
class PublicPageControllerTest {
    ...
    void setUp() {
        ...
        when(speakerService.list(1L, 1, 100, "", null, true))
                .thenReturn(new com.bjworld21.conference.dto.SpeakerPageResponse(List.of(), 1, 100, 0, 1, 0, 0));
        memberService = mock(MemberService.class);
        popupRepository = mock(com.bjworld21.conference.repository.PopupRepository.class);
    ...
    void noticeCanonicalUrlIncludesOnlyItsIdentity() throws Exception {
        ...
        when(boardPostService.getPublishedNotice(1L, 12L)).thenReturn(
                com.bjworld21.conference.dto.BoardPostResponse.builder().seq(12L).title("Notice")
