...
import com.bjworld21.conference.dto.AbstractSimilarityReviewItemResponse;
...
import com.bjworld21.conference.repository.AbstractSimilarityReviewRepository;
...
class AbstractSimilarityReviewServiceTest {
    ...
    void createsCurrentReviewAndImmutableHistoryEntry() {
        ...
        doAnswer(invocation -> {
            invocation.getArgument(0, com.bjworld21.conference.entity.AbstractSimilarityReview.class).setSeq(99L);
            return 1;
        ...
        ArgumentCaptor<com.bjworld21.conference.entity.AbstractSimilarityReview> reviewCaptor =
                ArgumentCaptor.forClass(com.bjworld21.conference.entity.AbstractSimilarityReview.class);
