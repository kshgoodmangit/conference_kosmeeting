...
import com.bjworld21.conference.dto.MailCampaignSummaryResponse;
...
public interface MailCampaignRepository {
    ...
    void insertJob(@Param("job") com.bjworld21.conference.entity.MailSendJob job,
    ...
    void insertRecipient(@Param("recipient") com.bjworld21.conference.entity.MailCampaignRecipient recipient,
