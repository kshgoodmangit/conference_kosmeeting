...
import com.bjworld21.congress.dto.AdminLoginRequest;
import com.bjworld21.congress.dto.AdminLoginResponse;
import com.bjworld21.congress.dto.AdminPageResponse;
import com.bjworld21.congress.dto.AdminResponse;
import com.bjworld21.congress.dto.AdminAccountExcelDownloadRequest;
import com.bjworld21.congress.dto.AbstractCategoryResponse;
import com.bjworld21.congress.dto.ReviewerProfileRequest;
import com.bjworld21.congress.dto.TestReviewerCreateResponse;
import com.bjworld21.congress.service.AdminAccessLogService;
import com.bjworld21.congress.service.AdminService;
import com.bjworld21.congress.service.AdminBulkImportService;
...
public class AdminController {
    ...
    public ResponseEntity<?> resetPassword(@PathVariable Long seq, HttpServletRequest request) {
        ...
        if (!com.bjworld21.congress.config.AdminRolePolicy.isFullAdministrator(session.getAttribute("adminRole"))
                || seq.equals(actorSeq)) {
